...
# 1. Importları eski haline çevir
imports_to_remove = """import jsPDF from "jspdf";
import autoTable from "jspdf-autotable";
import { DayPicker, DateRange } from "react-day-picker";
import { format } from "date-fns";
import { tr } from "date-fns/locale";
import "react-day-picker/dist/style.css";"""
imports_to_restore = """import jsPDF from "jspdf";
import autoTable from "jspdf-autotable";"""
content = content.replace(imports_to_remove, imports_to_restore)

# 2. State Değiştir (Geri Al)
...
# 3. filteredFeed mantığı (Geri Al)
...
# 4. Render UI (Geri Al ve Kampanyalar stiline benzet)
