...
# Lucide-react importuna Percent ekleyelim
if "Percent," not in content:
    content = content.replace("CreditCard, Search, X, Clock, ArrowRight, History, Activity, Users as UsersIcon", "CreditCard, Search, X, Clock, ArrowRight, History, Activity, Users as UsersIcon, Percent, TrendingUp")

old_grid = """          <div className="grid grid-cols-3 gap-4 w-full max-w-2xl mt-2">
...
new_grid = """          <div className="grid grid-cols-3 md:grid-cols-6 gap-3 w-full max-w-4xl mt-2">
