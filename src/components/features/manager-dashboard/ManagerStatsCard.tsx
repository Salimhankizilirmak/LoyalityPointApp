...
export function ManagerStatsCard() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <div className="bg-surface-container-lowest rounded-xl p-6 shadow-sm border border-outline-variant/20 relative overflow-hidden group hover:shadow-md transition-shadow" aria-label="Günlük Toplam İşlem İstatistiği">
      ...
      <div className="bg-surface-container-lowest rounded-xl p-6 shadow-sm border border-outline-variant/20 relative overflow-hidden group hover:shadow-md transition-shadow" aria-label="Günlük Dağıtılan Puan İstatistiği">
      ...
      <div className="bg-surface-container-lowest rounded-xl p-6 shadow-sm border border-outline-variant/20 relative overflow-hidden group hover:shadow-md transition-shadow" aria-label="Aktif Kasiyer Sayısı İstatistiği">
