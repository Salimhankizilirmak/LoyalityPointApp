...
export function BossTeamClient({ initialMembers }: { initialMembers: any[] }) {
  ...
  // Davet bekleyenleri filtreleyebiliriz veya burada da silebiliriz ama simdilik kayitli calisanlari kullaniyoruz.
  const validMembers = members.filter(m => m.id && !m.id.startsWith("inv-"));
