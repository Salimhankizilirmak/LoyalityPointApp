...
export function getBossInvitationTemplate(inviteLink: string): string {
  ...
  return `
    ...
    <html>
      <head>
        ...
        <title>Loyalty Davetiyesi</title>
        <style>
          body {
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h1>Patron Daveti</h1>
            <p>Merhaba,</p>
            <p>Loyalty sadakat puanı platformunda şirketiniz başarıyla oluşturuldu. Platformu yönetmeye başlamak ve kurulum adımlarını tamamlamak üzere davet edildiniz.</p>
