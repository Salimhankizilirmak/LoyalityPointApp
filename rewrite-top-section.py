...
# Başlangıç: {/* ── 1. ÜST KISIM: KAMPANYA VE STATS ── */}
# Bitiş: {/* ── 2. ORTA KISIM: ARAMA VE MÜŞTERİ (Eşit Genişlik & Yükseklik) ── */}

pattern = r"\{\/\* ── 1\. ÜST KISIM: KAMPANYA VE STATS ── \*\/}.*?(?=\{\/\* ── 2\. ORTA KISIM: ARAMA VE MÜŞTERİ)"
...
# Regex ile degistirelim (re.DOTALL ile multiline mathcing)
